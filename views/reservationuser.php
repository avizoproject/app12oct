...
<html>
	...
	<div class="wrapper">
        <?php
        require_once $_SERVER["DOCUMENT_ROOT"] . '/views/wrapperUser.php';
        ?>
	...
	<script type="text/javascript">
                ...
                var $sc = $("#schedule").timeSchedule({
                    ...
                    click: function (node, data) {
                        swal({
                            ...
                            window.location.href = "/views/updateReservation.php?id=" + pk;
                        })
                    },
    	...
    	$(document).ready(function(){
                ...
                $('#Modifier').click(function () {
                    ...
                    if ($('#example tr.selected td:first').length > 0) {
                        ...
                        if(statutReservation == "Inactif"){
                            ...
                            window.location.href = "/views/updateReservation.php?id=" + idcont + "";
                        }
                    }else{
                        swal({
                                title:"",
                ...
                $('#Retourner').click(function () {
                    if ($('#example tr.selected td:first').length > 0) {
                        ...
                        if(statutReservation == "Inactif"){
                            ...
                            var idcont = $('#example tr.selected td:first').html();
                            window.location.href = "/views/returnReservation.php?idres=" + idcont + "";
                        }
                    }else{
                        swal({
                            title:"",
            ...
            $('#Historique').click(function () {
                ...
                $('#Ajouter').click(function () {
                    window.location.href = "/views/addReservation.php";
                });
        ...
        if($_SESSION['loggedIn']==false){
            ...
            require_once $_SERVER["DOCUMENT_ROOT"] . '/views/modalUserReservations.php';
        }
