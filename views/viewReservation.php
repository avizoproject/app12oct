                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group label-static">
                                                ...
                                                <input type='text' size="40" class="flatpickr form-control"
                                                       data-enabletime=true data-enable-seconds=true
                                                       name="date_acquisition" id='acquisition'
                                                       placeholder="Choisissez la période de réservation" disabled>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group label-static">
                                                ...
                                                <select class="form-control" id="vehicule" name="select"
                                                        disabled><?php $listVehicule->getVehiculeReservation($_GET["id"]); ?></select>
                                            </div>
                                        </div>

                                    </div>
                                    <input type="submit" id="modifier" class="btn pull-right margin-button2"
                                           value="Modifier">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", "#retour", function (e) {
            e.preventDefault();
            location.href = "/reservationuser.php";
        });

        $(document).on("click", "#modifier", function (e) {
            e.preventDefault();
            location.href = "/views/updateReservation.php?id=<?php echo $_GET["id"]; ?>";
