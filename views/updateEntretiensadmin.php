...
session_start();
error_reporting(0);
require_once $_SERVER["DOCUMENT_ROOT"] . '/models/info_entretien.php';
require_once $_SERVER["DOCUMENT_ROOT"] . '/models/info_vehicule.php';
require_once $_SERVER["DOCUMENT_ROOT"] . '/models/info_user.php';
require_once $_SERVER["DOCUMENT_ROOT"] . '/models/info_invoice.php';
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                ...
                swal({
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            window.location.replace("/views/entretienAdmin.php");
                        },
        ...
        $('.navbar-header a').html("Modification d'entretien");
