                ...
                var $sc = $("#schedule").timeSchedule({
                    ...
                    click: function (node, data) {
                        swal({
                            ...
                            window.location.href = "/views/updateReservationadmin.php?id=" + pk;
                        })
        	...
        	demo.initDashboardPageCharts();
                ...
                $('#Modifier').click(function () {
                    ...
                    if ($('#example tr.selected td:first').length > 0) {
                        ...
                        window.location.href = "/views/updateReservationadmin.php?id=" + idcont + "";
                    }else{
                        swal({
                                title:"",
                ...
                $('#Consulter').click(function () {
                    if ($('#example tr.selected td:first').length > 0) {
                        ...
                        window.location.href = "/views/viewReservationAdmin.php?id=" + idcons + "";
                    }else{
                        swal({
                                title:"",
                                text:"Vous devez sélectionner une réservation.",
                ...
                $('#Ajouter').click(function () {
                    window.location.href = "/views/addReservationadmin.php";
                });
